...
namespace domi {
    ...
    struct BuildOptions {
        ...
        std::map<string, vector<OpExecuteDevice>> opExecuteDeviceConfig;
    };
    ...
    private:
         ...
         */
        bool BuildModelOnline(const std::string& hiaiVersion, ge::ComputeGraphPtr graph, ge::Model& irModel,
         ...
         * @return bool 成功返回true，失败返回false
         */
        bool BuildModelOffline(const std::string& hiaiVersion, ge::ComputeGraphPtr graph, ge::Model& irModel,
            ModelBufferData& output, const BuildOptions& options);
        /*
         * @ingroup domi_omg
